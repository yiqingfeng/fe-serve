...
//  */
// function getMaxPrecision(...nums: num[]): number {
...
//  */
// function getTotalPrecision(...nums: num[]): number {
//     let total = 0;
//     nums.forEach((num) => {
//         let len: number;
//         try {
...
// /**
//  * @description 将元数据转换为数字
//  */
// function toNumber(num: num): number {
//     let data = Number(num);
//     if (isNaN(data)) {
//         data = 0;
//     }
...
// function preExpCalc(expQueue: num[] | string = []): num[] {
//     if (Array.isArray(expQueue)) {
//         return expQueue.map((item: num) => {
